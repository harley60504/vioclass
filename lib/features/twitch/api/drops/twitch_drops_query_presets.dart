...
class TwitchDropsQueryPresets {
  const TwitchDropsQueryPresets._();
  ...
  static String collectRewardJson({
    ...
    return _encode(<String, dynamic>{
      ...
      'variables': <String, dynamic>{
        'input': <String, dynamic>{'dropInstanceID': dropInstanceId.trim()},
      },
  ...
  static String _encode(Object value, {required bool pretty}) {
    if (pretty) {
