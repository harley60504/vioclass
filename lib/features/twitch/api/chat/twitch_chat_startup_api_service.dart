...
class TwitchChatStartupApiService {
  ...
  const TwitchChatStartupApiService({required this.gql});
  ...
  Future<List<TwitchWebGqlPersistedResult>> fetchStartupBatch({
    ...
    final operations = <TwitchWebGqlPersistedOperation>[
      ...
      TwitchWebGqlPersistedOperation(
        ...
        sha256Hash:
            '7514aeb3d2c203087b83e920f8d36eb18a5ca1bfa96a554ed431255ecbbbc089',
      ),
      TwitchWebGqlPersistedOperation(
        operationName: 'MessageBuffer_Channel',
        variables: <String, dynamic>{'channelLogin': login},
        sha256Hash:
            'bfc959904f55b5003ae4674d4bea83ebdcd8867ad76e12f38957d433902d2fcc',
      ),
      TwitchWebGqlPersistedOperation(
      ...
      TwitchWebGqlPersistedOperation(
        ...
        variables: <String, dynamic>{'channelLogin': login},
        sha256Hash:
            'e31355d5fd19bf9b3c0907c8302ce9ff5466d06230bec209f78cf04724b7380c',
      ),
      TwitchWebGqlPersistedOperation(
        operationName: 'ChatRoomState',
        variables: <String, dynamic>{'login': login},
        sha256Hash:
            '9e0f79669e31950c658459564bc4cff236ac9c03e534cc32769ac58bc0cdd708',
      ),
      TwitchWebGqlPersistedOperation(
      ...
      TwitchWebGqlPersistedOperation(
        ...
        sha256Hash:
            'd8ab574eb44e3e82aabc96fc9c59af6eafead3e96262910a6396c007e7a11e05',
      ),
      TwitchWebGqlPersistedOperation(
        operationName: 'PinnedCheersSettings',
        variables: <String, dynamic>{'login': login},
        sha256Hash:
            'ca73cb0396fe5bcbe05c906fd472622e4b873eeb07699c2664026a079aeec631',
      ),
    ];
