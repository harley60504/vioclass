...
/// Stage 249 app-local notification overlay.
///
/// This widget is mounted once from MaterialApp.builder. It stays independent
/// from player/chat rebuilds and can be reused by Drops monitor later.
class TwitchAppNotificationOverlayStage249 extends StatelessWidget {
  final Widget child;

  const TwitchAppNotificationOverlayStage249({
    super.key,
    required this.child,
  });
                      ...
                      children: <Widget>[
                        for (final item in items)
                          Padding(
                            ...
                            child: _TwitchAppNotificationCardStage249(
                              item: item,
                              onDismiss: () {
...
class _TwitchAppNotificationCardStage249 extends StatelessWidget {
  final TwitchAppNotificationStage249 item;
  final VoidCallback onDismiss;

  const _TwitchAppNotificationCardStage249({
    required this.item,
